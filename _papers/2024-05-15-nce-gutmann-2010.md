...
The first time I read this paper, it was interesting because it (and also some other works) present the idea of "learning by comparison". In fact, the novelty in this paper is simple and makes intuitive sense. Moreover, the if we take the distribution of some other set of data to be the noise distribution, we get the ideas of contrastive learning.
